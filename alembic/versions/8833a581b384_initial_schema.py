...
Revision ID: 8833a581b384
Revises: 
Create Date: 2025-10-06 12:32:34.432878
...
def upgrade() -> None:
    ...
    sa.Column('row_entry_date', sa.DateTime(), nullable=True),
    sa.Column('row_update_date', sa.DateTime(), nullable=True),
    sa.Column('type_name', sa.String(), nullable=True),
    sa.Column('description', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('obs_type',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('standard_name', sa.String(length=50), nullable=True),
    ...
    sa.Column('opendap_url', sa.String(length=200), nullable=True),
    sa.Column('email_tech', sa.String(length=150), nullable=True),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('platform_metadata',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('row_entry_date', sa.DateTime(), nullable=True),
    sa.Column('row_update_date', sa.DateTime(), nullable=True),
    sa.Column('country_code', sa.CHAR(length=2), nullable=False),
    sa.Column('country_name', sa.String(length=100), nullable=True),
    sa.Column('admin_area_level_1', sa.String(length=150), nullable=True),
    sa.Column('admin_area_level_2', sa.String(length=150), nullable=True),
    sa.Column('admin_area_level_3', sa.String(length=150), nullable=True),
    ...
    sa.Column('fixed_lon', sa.Float(), nullable=True),
    sa.Column('min_lon', sa.Float(), nullable=True),
    sa.Column('max_lon', sa.Float(), nullable=True),
    sa.Column('fixed_lat', sa.Float(), nullable=True),
    sa.Column('min_lat', sa.Float(), nullable=True),
    sa.Column('max_lat', sa.Float(), nullable=True),
    sa.Column('fixed_z', sa.Float(), nullable=True),
    sa.Column('min_z', sa.Float(), nullable=True),
    sa.Column('max_z', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['type_id'], ['collection_type.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('m_scalar_type',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('obs_type_id', sa.Integer(), nullable=True),
    sa.Column('uom_type_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['obs_type_id'], ['obs_type.row_id'], ),
    sa.ForeignKeyConstraint(['uom_type_id'], ['uom_type.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    ...
    sa.Column('type_id', sa.Integer(), nullable=True),
    sa.Column('short_name', sa.String(length=50), nullable=True),
    sa.Column('platform_handle', sa.String(length=100), nullable=True),
    ...
    sa.Column('app_catalog_id', sa.Integer(), nullable=True),
    sa.Column('long_name', sa.String(length=200), nullable=True),
    sa.Column('description', sa.String(length=1000), nullable=True),
    sa.Column('url', sa.String(length=200), nullable=True),
    sa.Column('metadata_id', sa.Integer(), nullable=True),
    sa.Column('the_geom', Geometry(), nullable=True),
    sa.ForeignKeyConstraint(['metadata_id'], ['platform_metadata.row_id'], ),
    sa.ForeignKeyConstraint(['organization_id'], ['organization.row_id'], ),
    sa.ForeignKeyConstraint(['type_id'], ['platform_type.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('timestamp_lkp',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('row_entry_date', sa.DateTime(), nullable=True),
    sa.Column('row_update_date', sa.DateTime(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['product_id'], ['product_type.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('m_type',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('num_types', sa.Integer(), nullable=True),
    sa.Column('description', sa.String(length=1000), nullable=True),
    sa.Column('m_scalar_type_id', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_2', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_3', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_4', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_5', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_6', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_7', sa.Integer(), nullable=True),
    sa.Column('m_scalar_type_id_8', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['m_scalar_type_id'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_2'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_3'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_4'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_5'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_6'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_7'], ['m_scalar_type.row_id'], ),
    sa.ForeignKeyConstraint(['m_scalar_type_id_8'], ['m_scalar_type.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    ...
    sa.Column('end_date', sa.DateTime(), nullable=True),
    sa.Column('row_update_date', sa.DateTime(), nullable=True),
    sa.Column('platform_handle', sa.String(length=50), nullable=True),
    sa.Column('author', sa.String(length=100), nullable=True),
    sa.Column('reason', sa.String(length=500), nullable=True),
    sa.Column('status', sa.Integer(), nullable=True),
    sa.Column('platform_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['platform_id'], ['platform.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    ...
    sa.Column('type_id', sa.Integer(), nullable=True),
    sa.Column('short_name', sa.String(length=50), nullable=True),
    sa.Column('m_type_id', sa.Integer(), nullable=True),
    sa.Column('fixed_z', sa.Float(), nullable=True),
    sa.Column('active', sa.Integer(), nullable=True),
    sa.Column('begin_date', sa.DateTime(), nullable=True),
    sa.Column('end_date', sa.DateTime(), nullable=True),
    sa.Column('s_order', sa.Integer(), nullable=True),
    sa.Column('url', sa.String(length=200), nullable=True),
    sa.Column('metadata_id', sa.Integer(), nullable=True),
    sa.Column('report_interval', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['m_type_id'], ['m_type.row_id'], ),
    sa.ForeignKeyConstraint(['platform_id'], ['platform.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('multi_obs',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('row_entry_date', sa.DateTime(), nullable=True),
    sa.Column('row_update_date', sa.DateTime(), nullable=True),
    sa.Column('platform_handle', sa.String(length=100), nullable=True),
    ...
    sa.Column('m_type_id', sa.Integer(), nullable=True),
    sa.Column('m_date', sa.DateTime(), nullable=True),
    sa.Column('m_lon', sa.Float(), nullable=True),
    sa.Column('m_lat', sa.Float(), nullable=True),
    sa.Column('m_z', sa.Float(), nullable=True),
    sa.Column('m_value', sa.Float(), nullable=True),
    sa.Column('m_value_2', sa.Float(), nullable=True),
    sa.Column('m_value_3', sa.Float(), nullable=True),
    sa.Column('m_value_4', sa.Float(), nullable=True),
    sa.Column('m_value_5', sa.Float(), nullable=True),
    sa.Column('m_value_6', sa.Float(), nullable=True),
    sa.Column('m_value_7', sa.Float(), nullable=True),
    sa.Column('m_value_8', sa.Float(), nullable=True),
    sa.Column('qc_metadata_id', sa.Integer(), nullable=True),
    sa.Column('qc_level', sa.Integer(), nullable=True),
    sa.Column('qc_flag', sa.String(length=100), nullable=True),
    sa.Column('qc_metadata_id_2', sa.Integer(), nullable=True),
    sa.Column('qc_level_2', sa.Integer(), nullable=True),
    sa.Column('qc_flag_2', sa.String(length=100), nullable=True),
    sa.Column('metadata_id', sa.Integer(), nullable=True),
    sa.Column('d_label_theta', sa.Integer(), nullable=True),
    sa.Column('d_top_of_hour', sa.Integer(), nullable=True),
    sa.Column('d_report_hour', sa.DateTime(), nullable=True),
    sa.Column('the_geom', Geometry(), nullable=True),
    sa.ForeignKeyConstraint(['m_type_id'], ['m_type.row_id'], ),
    sa.ForeignKeyConstraint(['sensor_id'], ['sensor.row_id'], ),
    sa.PrimaryKeyConstraint('row_id')
    )
    op.create_table('sensor_status',
    sa.Column('row_id', sa.Integer(), nullable=False),
    sa.Column('sensor_id', sa.Integer(), nullable=True),
    sa.Column('sensor_name', sa.String(length=50), nullable=True),
    sa.Column('platform_id', sa.Integer(), nullable=True),
    sa.Column('row_entry_date', sa.DateTime(), nullable=True),
    sa.Column('begin_date', sa.DateTime(), nullable=True),
    sa.Column('end_date', sa.DateTime(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table('multi_obs')
    op.drop_table('sensor')
    op.drop_table('platform_status')
    op.drop_table('m_type')
    op.drop_table('timestamp_lkp')
    op.drop_table('platform')
    op.drop_table('m_scalar_type')
    op.drop_table('collection')
    op.drop_table('uom_type')
    op.drop_table('product_type')
    op.drop_table('platform_type')
    op.drop_table('platform_metadata')
    op.drop_table('organization')
    op.drop_table('obs_type')
    op.drop_table('collection_type')
    # ### end Alembic commands ###
